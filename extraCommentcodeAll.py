...
# #     def project(self, x):
# #         # x is expected to be [batch_size, d_model]
# #         return self.projection_layer(x)
...
# # Load tokenizer (BERT tokenizer for tokenizing reviews)
...
#         decoder_output = model.decode(encoder_output, src_mask, tgt.unsqueeze(1), tgt_mask)
...
#             correct += (preds.squeeze(1) == tgt).sum().item()
#             total += tgt.size(0)
